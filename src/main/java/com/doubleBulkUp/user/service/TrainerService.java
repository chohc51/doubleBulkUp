...
//        return trainerRepository.findByTrainerIdContaining(keyword)
//                .stream()
//                .map(TrainerBriefResponseDto::new)
//                .collect(Collectors.toList());
//    }
...
//    public List<TrainerBriefResponseDto> findMyAll(String trainerId) {
...
//
//
//    public TrainerBriefResponseDto findById(String trainerId) {
//        return TrainerRepository.findById(boardId)
